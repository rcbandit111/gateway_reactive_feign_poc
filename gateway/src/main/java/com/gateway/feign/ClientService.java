...
//    }
    ...
    public ResponseEntity<BasicTokenResponseDto> getJwtWithRestTemplate(String key)
        ...
        HttpEntity<ApiKey> request = new HttpEntity<>(apiKey, headers);

        return restTemplate
                .exchange("http://localhost:8554/greeting", HttpMethod.POST, request, BasicTokenResponseDto.class);
    }
